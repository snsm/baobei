...
<body bgcolor="f8f8f8">
<div class="r_content">
    <div class="r_top_nav">修改问题</div>
    <div class="r_public_con">

        <form id="jsForm" action="<?=Url::to(['other/update']);?>" method="post">
            <table width="98%" border="0" cellpadding="3" cellspacing="0" align="center">
                <tr>
                    <td width="13%" align="right">问：</td>
                    <td>
                        <div class="controls">
                            <input class="r_public_con_input_text" type="text" name="other_title" value="<?=$model[0]['other_title'];?>" required data-msg-required="不能为空" style="width:400px; height:20px;"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="controls">
                            <input class="r_public_con_input_text" type="text" name="other_content" value="<?=$model[0]['other_content'];?>" required data-msg-required="不能为空" style="width:400px; height:20px;"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="hidden" name="other_id" value="<?=$model[0]['other_id'];?>" />
                        <input type="hidden" name="other_time" value="<?php date_default_timezone_set("PRC"); echo date("Y-m-d H:i:s"); ?>" />
