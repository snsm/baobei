...
<body bgcolor="f8f8f8">
<div class="r_content">
    <div class="r_top_nav">上传方案</div>
    <div class="r_public_con">

        <form id="jsForm" action="<?=Url::to(['scheme/upload']);?>" method="post">
            <table width="98%" border="0" cellpadding="3" cellspacing="0" align="center">
                <tr>
                    <td width="13%" align="right">方案标题：</td>
                    <td>
                        <div class="controls">
                            <input class="r_public_con_input_text" type="text" name="sc_title" required data-msg-required="不能为空" style="width:400px; height:20px;"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="controls">
                            <input class="r_public_con_input_text" type="text" name="sc_renqun" required data-msg-required="不能为空" style="width:400px; height:20px;"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="controls">
                            <input class="r_public_con_input_text" type="text" name="sc_tedian" required data-msg-required="不能为空" style="width:400px; height:20px;"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                            <textarea id="sc_content" name="sc_content" style="width:670px;height:300px;"></textarea>
                            <script>
