...
<body bgcolor="f8f8f8">
<div class="r_content">
    <div class="r_top_nav">会员密码更新</div>
    <div class="r_public_con">

        <form id="jsForm" action="<?=Url::to(['member/member_update']);?>" method="post">
            <table width="98%" border="0" cellpadding="3" cellspacing="0" align="center">
                <tr>
                    <td width="13%" align="right"><?=Yii::t('power','baobeiren')?></td>
                    <td><font color="#FF9900"><?=$model[0]['baobeiren']?></font></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="hidden" name="mid" value="<?=$model[0]['mid']?>" />
